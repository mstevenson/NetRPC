...
namespace NetRPC
{
	public class ServerBeacon
	{
		...
		/// </summary>
		public static readonly string serviceId = "HRCP";
		...
		/// </summary>
		public ushort sendReceivePort = 17014;
		...
		{
			return string.Format ("{0} v{1} {2} {3} {4}", serviceId, version, address, sendReceivePort);
		}
